...
#instead of writing three different scenarios we use scenario outline and the examples
...
#    Given the user logged in as "admin"
  ...
  Scenario Outline: Different user types
    ...
    Examples:
      ...
      | store manager |
      | sales manager |
#    example of Data Driven Testing. this is the same as above commented out part